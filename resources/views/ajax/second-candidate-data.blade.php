                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-horizontal form-label-left input_mask" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="slot_date" name="appointment_date"
                                        type="date" value="{{$data->schedule_date}}" onchange="CheckSlotDate('{{route('slot.time')}}')">
                                </div>
                            </div>
                            <div class="form-group" id="LoadSlotData">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <input class="form-control has-feedback-left" id="slot_time" name="appointment_time"
                                        type="text" value="{{$data->schedule_time}}" >
                                </div>
                            </div>
                            <div class="form-group" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                                    <textarea name="second_feedback" id="second_feedback" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            ...
                            onclick="VerifyLead('{{route('candidate.second.update')}}','CandidateData','{{route('home')}}')"
                            >Submit</button>
                        </div>
                    </div>
