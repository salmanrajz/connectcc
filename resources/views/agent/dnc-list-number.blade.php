...
@endif
   <form method="post" enctype="multipart/form-data" action="{{route('dnc.checker.new.list')}}">
    {{ csrf_field() }}
    @if($errors->any())
     ...
     <table class="table">
      <tr>
       <td width="40%" align="right"><label>Type Number for Filter via DNC
        <p>
            Limit 100 Number Only</p>
    </label></td>
       <td width="30">
           <textarea name="list" id="list" cols="30" rows="10" class="form-control"></textarea>
           <textarea name="message" id="message" cols="30" rows="10" class="form-control" style="display:none;"></textarea>
       ...
       <td width="30%" align="left">
           {{-- @if($httpcode == 200) --}}
            <input type="submit" name="upload" class="btn btn-primary" value="Filter" id="FilterBTN" >
            {{-- @else --}}
            {{-- <input type="submit" name="upload" class="btn btn-primary" value="Filter" id="FilterBTN" style="display: :none"> --}}
            {{-- <input type="button" name="upload" class="btn btn-danger" value="DNC Filter Offline" id="FilterBTNDanger" style="display: none"> --}}
            {{-- @endif --}}
       </td>
      </tr>
      <tr>
