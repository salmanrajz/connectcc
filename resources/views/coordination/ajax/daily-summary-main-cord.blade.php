            ...
            <div class="col-sm-3 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column h-100 mb-0">
                    <div
                        ...
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold">
                                    {{$HomeCount::appointment_lead_count()}}
            ...
            <div class="col-sm-3 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column h-100 mb-0">
                    <div
                        ...
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold">
                                    {{$HomeCount::active_lead_count_daily()}}
