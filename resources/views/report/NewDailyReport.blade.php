...
@section('content')
<div class="container">
    {{-- <h6 class="text-left display-6">{{$channel_partner}}</h6> --}}
</div>
<div class="container">
    <div class="row">
        <div class="md-offset-4">
            <div class="row">
                {{-- <button class="btn btn-success ml-3 mb-3" onclick="window.location.href='{{url('MainReport/ConnectCC')}}'">ED</button> --}}
            ...
            <div class="table-responsive">
                ...
                <table class=" table-bordered text-center" style="font-weight:400;">
                    ...
                    <thead>
                        <tr>
                            <th colspan="12" style="background:#FFC107">
                                <h6>
                            ...
                            <th colspan="3" style="background:#FFC107;border:3px solid red">
                                <h6>
                                    Commitment
                                </h6>
                            </th>
                            <th colspan="3" style="background:#FFC107;border:3px solid blue">
                                <h6>
                                    Non Commitment
                                </h6>
                            </th>
                        ...
                        <tr style="background:black;color:#fff">
                            ...
                            {{-- <th>>0 to 124 C</th> --}}
                            <th style="border-left:2px solid red">125 to 149 C</th>
                            <th>150 to 224 C</th>
                            <th style="border-right:2px solid red">225 Plus C</th>
                            {{-- <th>>0 to 124 NC</th> --}}
                            <th style="border-left:2px solid red">125 to 149 NC</th>
                            <th>150 to 224 NC</th>
                            <th >225 Plus NC</th>
                            <th>PV
                                {{-- (1.02) --}}
                    ...
                    <tbody>
                        ...
                        <tr style="background:#6363d2;color:#fff">
                            ...
                            <td>
                                {{$hw_act = $provider::CalCenterLeadtypeDateHomeWifi($cc->call_center_code,'1.02','postpaid',$channel_partner)}}
                            </td>
                            <td>
                                {{$hw_ip = $provider::CalCenterLeadtypeDateHomeWifi($cc->call_center_code,'inprocess','HomeWifi',$channel_partner)}}
                            </td>
                            <td>
                                ...
                                {{$provider::CalCenterLeadtypeDate($cc->call_center_code,'inprocess','postpaid',$channel_partner)}}
                                                       ...
                                                       <td>
                                {{$provider::CalCenterLeadtypeDate($cc->call_center_code,'mnpinprocess','postpaid',$channel_partner)}}
                            </td>
                            </td>
                                                       <td>
                            ...
                            {{--  --}}
                            {{-- <td>
                                {{$provider::planrangecdaily($cc->call_center_code,$channel_partner,0,124)}}
                            </td> --}}
                            <td style="border-left:2px solid red">
                                {{$provider::planrangecdaily($cc->call_center_code,$channel_partner,125,149)}}
                            </td>
                            <td>
                                {{$provider::planrangecdaily($cc->call_center_code,$channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid red">
                                {{$provider::planrangecdaily($cc->call_center_code,$channel_partner,'225plus',225)}}
                            </td>
                            {{--  --}}
                            {{-- <td>
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,0,124)}}
                            </td> --}}
                            <td>
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,125,149)}}
                            </td>
                            <td >
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid blue">
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,'225plus',225)}}
                            </td>
                            ...
                            <td>
                                {{$provider::CalCenterLeadtypeDate($cc->call_center_code,'mnpfollowup','postpaid',$channel_partner)}}
                            </td>
                            {{-- <td>
                            ...
                            <td>
                                {{$xtra =$provider::final_ep_calculator_daily($cc->call_center_code,$channel_partner)}}
                        ...
                        <tr style="background:ffeb3b85;color:#000;font-weight:bold;border:none">
                            ...
                            <td>
                                {{$ab_homewifi = $provider::CalCenterTodayHomeWifi($cc->call_center_code,'1.02','postpaid',$channel_partner)}}
                            </td>
                            <td>
                                {{$inp_homewifi = $provider::CalCenterTodayHomeWifi($cc->call_center_code,'inprocess','homewifi',$channel_partner)}}
                            </td>
                            <td>
                            ...
                            <td>
                                {{$provider::CalCenterToday($cc->call_center_code,'mnpinprocess','postpaid',$channel_partner)}}
                            </td>
                            <td>
                           ...
                           {{-- <td>
                                {{$provider::planrangecdailyall($channel_partner,0,124)}}
                            </td> --}}
                            <td style="border-left:2px solid red;border-bottom:2px solid red">
                                {{$provider::planrangecdailyall($channel_partner,125,149)}}
                            </td>
                            <td style="border-bottom:2px solid red">
                                {{$provider::planrangecdailyall($channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid red;border-bottom:2px solid red">
                                {{$provider::planrangecdailyall($channel_partner,'225plus',225)}}
                            </td>
                            {{--  --}}
                            {{-- <td>
                                {{$provider::planrangencdailyall($channel_partner,0,124)}}
                            </td> --}}
                            <td style="border-left:2px solid blue;border-bottom:2px solid blue">
                                {{$provider::planrangencdailyall($channel_partner,125,149)}}
                            </td>
                            <td style="border-bottom:2px solid blue">
                                {{$provider::planrangencdailyall($channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid blue;border-bottom:2px solid blue">
                                {{$provider::planrangencdailyall($channel_partner,'225plus',225)}}
                            </td>
                            {{-- <td>
                            </td>
                            <td>
                            ...
                            <td>
                                {{$provider::CalCenterToday($cc->call_center_code,'mnpfollowup','postpaid',$channel_partner)}}
                            </td>
                            {{-- <td>
                                0
                            </td> --}}
                            ...
                            <td>
                               {{$xtra =$provider::final_ep_calculator_dailyall($channel_partner)}}
                                {{-- {{$xxx}} --}}
                                {{-- {{$xtra = $zzz * 75 + $xxx * 225}} --}}
                            </td>
                            <td>
                ...
                <table class=" table-bordered text-center" style="font-weight:400;">
                    ...
                    <thead>
                        <tr>
                            <th colspan="10" style="background:#FFC107">
                                <h6>
                        ...
                        <tr style="background:black;color:#fff">
                            ...
                            <th style="border-right:2px solid red">225 Plus C</th>
                            {{-- <th>>0 to 124 NC</th> --}}
                            <th style="border-left:2px solid blue">125 to 149 NC</th>
                            <th>150 to 224 NC</th>
                            <th style="border-right:2px solid blue">225 Plus NC</th>
                            {{-- <th>>150</th>
                            <th>150 to 225</th>
                            <th>225+</th> --}}
                            <th>Verified
                    ...
                    <tbody>
                        ...
                        {{$provider::NumberOfAgent($cc->call_center_code)}}
                            ...
                            <td>
                                {{$hw_act = $provider::CalCenterLeadtypeHW($cc->call_center_code,'1.02','HomeWifi',$channel_partner)}}
                                {{-- {{}} --}}
                            </td>
                            <td>
                                {{$hw_inp = $provider::CalCenterLeadtypeHW($cc->call_center_code,'inprocess','HomeWifi',$channel_partner)}}
                                {{-- {{}} --}}
                            </td>
                            <td>
                            ...
                            <td>
                                {{$provider::CalCenterLeadtypePlan($cc->call_center_code,'Diamond','postpaid',$channel_partner)}}
                            </td>
                             <td style="border-left:2px solid red">
                                {{$provider::planrangecmonthly($cc->call_center_code,$channel_partner,125,149)}}
                            </td>
                            <td>
                                {{$provider::planrangecmonthly($cc->call_center_code,$channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid red">
                                {{$provider::planrangecmonthly($cc->call_center_code,$channel_partner,'225plus',225)}}
                            </td>
                            {{--  --}}
                            {{-- <td>
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,0,124)}}
                            ...
                            <td style="border-left:2px solid blue">
                                {{$provider::planrangencmonthly($cc->call_center_code,$channel_partner,125,149)}}
                            </td>
                            <td>
                                {{$provider::planrangencmonthly($cc->call_center_code,$channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid blue">
                                {{$provider::planrangencmonthly($cc->call_center_code,$channel_partner,'225plus',225)}}
                            </td>
                            {{-- <td>
                            ...
                            <td>
                                {{$provider::CalCenterLeadtype($cc->call_center_code,'mnpfollowup','postpaid',$channel_partner)}}
                            </td>
                            <td>
                            ...
                            <td>
                                {{-- B - --}}
                                {{$xtra =$provider::final_ep_calculator_monthly($cc->call_center_code,$channel_partner)}}
                        ...
                        <tr style="background:ffeb3b85;color:#000;font-weight:bold">
                            ...
                            <td>
                                {{$hw_act = $provider::CalCenterTotalMonthHW($cc->call_center_code,'1.02','HomeWifi',$channel_partner)}}
                            </td>
                            <td>
                                {{$hw_inp = $provider::CalCenterTotalMonthHW($cc->call_center_code,'inprocess','HomeWifi',$channel_partner)}}
                            </td>
                                                        <td>
                            ...
                            <td>
                                {{$provider::CalCenterMonthlyPlan($cc->call_center_code,'Diamond','postpaid',$channel_partner)}}
                            </td>
                            <td style="border-left:2px solid red;border-bottom:2px solid red">
                                {{$provider::planrangecmonthlyall($channel_partner,125,149)}}
                            </td>
                            <td style="border-bottom:2px solid red">
                                {{$provider::planrangecmonthlyall($channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid red;border-bottom:2px solid red">
                                {{$provider::planrangecmonthlyall($channel_partner,'225plus',225)}}
                            </td>
                            {{--  --}}
                            {{-- <td>
                                {{$provider::planrangencdaily($cc->call_center_code,$channel_partner,0,124)}}
                            ...
                            <td style="border-left:2px solid blue;border-bottom:2px solid blue">
                                {{$provider::planrangencmonthlyall($channel_partner,125,149)}}
                            </td>
                            <td style="border-bottom:2px solid blue">
                                {{$provider::planrangencmonthlyall($channel_partner,150,224)}}
                            </td>
                            <td style="border-right:2px solid blue;border-bottom:2px solid blue">
                                {{$provider::planrangencmonthlyall($channel_partner,'225plus',225)}}
                            </td>
                            {{-- <td>
                            ...
                            <td>
                                {{$provider::CalCenterTotalMonth($cc->call_center_code,'mnpfollowup','postpaid',$channel_partner)}}
                            </td>
                            {{-- <td>
                                0
                            </td> --}}
                            ...
                            <td>
                                {{$xtra =$provider::final_ep_calculator_monthlyall($cc->call_center_code,$channel_partner)}}
                                {{-- Zoom --}}
                                {{-- {{$xtra = $zzz * 75 + $xxx * 225}} --}}
                            </td>
                            <td>
            ...
            {{$fr = $xtra + $point}}
            <div class="hideme hidden d-none">
            @if(!empty($total_1))
                {{$ft = $total_1 + $total_2}}
                @else
                {{$ft = 1}}
            ...
            <p>
                Diamond: {{$provider::plan_category_act('Diamond',$channel_partner)}}
            </p>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-3 col-3">
                    <p>
                    ...
                    <p>
                        CT: {{$provider::CalCenterToday($cc->call_center_code,'1.02','postpaid','ConnectCC')}}
                    </p>
                    {{-- <p>
                ...
                <div class="col-md-3 col-sm-3 col-xs-3 col-3">
                    ...
                    <p>
                        CT: {{$provider::CalCenterTotalMonth($cc->call_center_code,'1.02','postpaid','ConnectCC')}}
                    </p>
                    {{-- <p>
            ...
            <div class="table-responsive  hidden d-none">
                <table class=" table-bordered text-center" style="font-weight:400;">
                    @inject('provider', 'App\Http\Controllers\ReportController')
                    <thead>
                        <tr>
                ...
                <table class=" table-bordered text-center" style="font-weight:400;">
                    ...
                    <thead>
                        <tr>
                            <th colspan="13" style="background:#FFC107">
                                <h6>
                                    Monthly Emirate Summary Connect >>
                                    {{$day = \Carbon\Carbon::parse($date = \Carbon\Carbon::today())->format('l')}},
                                    {{$day = \Carbon\Carbon::parse($date = \Carbon\Carbon::today())->format('M, d, Y')}}
                                </h6>
                            </th>
                    ...
                    <tbody style="background:#009688;color:#fff">
                        ...
                        <tr>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Dubai','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Dubai','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Sharjah','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Sharjah','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Ajman','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Ajman','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                             <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Umm ul Quwain','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Umm ul Quwain','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                             <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('RAK','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('RAK','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Fujairah','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Fujairah','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                             <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Khorfakhan','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Khorfakhan','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                             <tr>
                                <td>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Abu Dhabi','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Abu Dhabi','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Al Ain','inprocess','postpaid','ConnectCC')}}
                                </td>
                                <td>
                                    {{$provider::CalCenterLeadEmirate('Al Ain','1.02','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                {{$provider::CalCenterLeadEmirateAll('Dubai','inprocess','postpaid','ConnectCC')}}
                            </td>
                            <td>
                                {{$provider::CalCenterLeadEmirateAll('Dubai','1.02','postpaid','ConnectCC')}}
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="table-responsive  hidden d-none">
                <table class=" table-bordered text-center" style="font-weight:400;">
                    ...
                    <tbody style="background:#009688;color:#fff">
                        ...
                        // ->wherein('numberdetails.channel_type', ['TTF','ConnectCC','MWH','Ideacorp'])
                ...
                <table class=" table-bordered text-center" style="font-weight:400;">
                    ...
                    <tbody style="background:#009688;color:#fff">
                        ...
                        <tr>
                                ...
                                <td>
                                    {{$provider::CalCenterLeadCategory($item->type,'active','postpaid','ConnectCC')}}
                                </td>
                            </tr>
                        @endforeach
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                {{$provider::CalCenterLeadCategoryAll('Dubai','inprocess','postpaid','ConnectCC')}}
                            </td>
                        </tr>
                    </tfoot>
                </table>
