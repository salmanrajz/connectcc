...
class EtisalatMonthlyExport implements FromCollection, WithHeadings,ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    public function collection()
    {
        ...
        if($time == '1'){
            ...
            return $data = activation_form::select(\DB::raw('(@count:=@count+1) AS serial'), 'activation_forms.customer_name', 'activation_forms.activation_selected_no', 'activation_forms.activation_sr_no', 'plans.plan_name', 'activation_forms.emirate_location', 'activation_forms.sim_type', 'activation_forms.activation_date')
            ->LeftJoin(
                'plans',
                'plans.id',
            ...
            ->where('activation_forms.channel_type', 'TTF')
