...
class MonthlyLead implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
        //
        return $data = \App\lead_sale::select('lead_sales.customer_name', 'lead_sales.customer_number', 'users.name', 'users.agent_code', 'lead_sales.emirates', 'lead_sales.selected_number', 'lead_sales.sim_type', 'lead_sales.gender', 'lead_sales.nationality', 'plans.plan_name', 'status_codes.status_name', 'lead_sales.created_at')
        ->Join(
            'users',
            'users.id',
            'lead_sales.saler_id'
