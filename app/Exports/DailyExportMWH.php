...
class DailyExportMWH implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    public function collection()
    {
        ...
        if ($time == '1') {
            ...
            return $data = activation_form::select(\DB::raw('(@count:=@count+1) AS serial'),
                'lead_sales.created_at as submitted_date',
                'activation_forms.created_at as closing_date',
                'activation_forms.activation_selected_no', 'activation_forms.activation_sr_no',
                'activation_forms.customer_name',
                'plans.plan_name', 'activation_forms.sim_type', 'numberdetails.type'
            ...
            ->LeftJoin(
                'numberdetails','numberdetails.number','activation_selected_no'
            )
            ->LeftJoin(
                'plans',
                'plans.id',
            ...
            return $data = activation_form::select(
                ...
                'activation_forms.activation_sr_no',
                'activation_forms.customer_name',
                'plans.plan_name',
